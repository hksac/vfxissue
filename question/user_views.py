...
from question.forms import customAuthenticationForm
from question.forms import customUserCreationForm
import datetime
...
@csrf_protect
@never_cache
def user_login(request, template_name='user/login.html',
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            response = JsonResponse({'status':'ture'})
            response.set_cookie('_username',form.get_user(),expires=dt)
            return response
...
@csrf_protect
@never_cache
def user_logout(request, next_page=None,
...
@csrf_protect
@never_cache
def user_register(request, template_name='question/register.html',
          redirect_field_name=REDIRECT_FIELD_NAME,
    ...
    if not request.user.is_authenticated() and request.method == "POST":
        ...
        if request.POST.get('username'):
            ...
            try:
                ...
                return JsonResponse( {'error':u"密码有误"} )
